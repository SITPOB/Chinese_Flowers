...
public class pa {
    public static void main(String[] args) throws IOException {
        Elements elements_1 = null, elements_2 = null , other_name = null, keshu = null, fenlei = null, xttz = null, shxx = null;
        boolean f = false;
        String name = "";
        String  d_url;
        while(true){
            ...
            System.out.println(other_name.text());
            System.out.println(keshu.text());
